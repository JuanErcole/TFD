...
const Container = tw.div`relative bg-blue-200 -mx-8 px-8 text-gray-800`;
...
const Card = styled.div`
  ...
  .description {
    ${tw`mt-2 font-normal text-gray-800 leading-snug`}
  }
`;
  ...
  const defaultCards = [
    {
      ...
      description: "Creación de aplicaciones web y móviles a medida. Desarrollo de software empresarial escalable. Soluciones de comercio electrónico para impulsar tu presencia en línea."
    },
    {
